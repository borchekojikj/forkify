...
var _addRecepieViewJs = require("./views/addRecepieView.js");
var _addRecepieViewJsDefault = parcelHelpers.interopDefault(_addRecepieViewJs);
...
const controlAddBookmark = function() {
    ...
    if (!_modelJs.state.recipe.bookmarked) _modelJs.addBoomark(_modelJs.state.recipe);
...
const controlAddRecipe = async function(newRecipe) {
    ...
    try {
        (0, _addRecepieViewJsDefault.default).renderSpinner();
        await _modelJs.uploadRecipe(newRecipe);
        console.log(_modelJs.state.recipe);
        // Render Recipe
        (0, _recipeViewJsDefault.default).render(_modelJs.state.recipe);
        // Success message
        (0, _addRecepieViewJsDefault.default).renderMessage();
        // Render Bookmark viw
        (0, _bookmarksViewJsDefault.default).render(_modelJs.state.bookmarks);
        // Change ID URL
        ...
        // Close form window
        setTimeout(function() {
            (0, _addRecepieViewJsDefault.default).toggleWindow();
        }, (0, _configJs.MODAL_CLOSE_SEC) * 1000);
    } catch (error) {
        console.log(error.message);
        (0, _addRecepieViewJsDefault.default).renderError(error.message);
    }
// Model upload
};
const init = function() {
    ...
    (0, _addRecepieViewJsDefault.default)._addHandlerUpload(controlAddRecipe);
};
init();

},{"core-js/modules/web.immediate.js":"49tUX","./model.js":"Y4A21","./config.js":"k5Hzs","./views/recipeView.js":"l60JC","./views/searchView.js":"9OQAM","./views/resultsView.js":"cSbZE","./views/paginationView.js":"6z7bi","./views/addRecepieView.js":"eAsNV","./views/bookmarksView.js":"4Lqzq","regenerator-runtime/runtime":"dXNgZ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"49tUX":[function(require,module,exports) {
"use strict";
...
parcelHelpers.export(exports, "addBoomark", ()=>addBoomark);
...
const addBoomark = function(recipe) {
    // Add bookmark
...
const KEY = "e841adae-90d5-439c-b778-02e18675b637";
...
class RecipeView extends (0, _viewJsDefault.default) {
    ...
    _generateMarkupIngredient(ing) {
        return `
            ...
            <div class="recipe__quantity">${ing.quantity ? new (0, _fractionJsDefault.default)(ing.quantity) : ""}</div>
...
},{"./View.js":"5cUXS","url:../../img/icons.svg":"loVOp","fraction.js":"iDLoJ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"5cUXS":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _iconsSvg = require("url:../../img/icons.svg");
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
class View {
  ...
  */ render(data, render = true) {
        ...
        if (!data || Array.isArray(data) && data.length === 0) return this.renderError(); // Handle the error case
        this._data = data;
 ...
 */ (function(root) {
    ...
    var modpow = function(b, e, m) {
        for(var r = 1; e > 0; b = b * b % m, e >>= 1)if (e & 1) r = r * b % m;
        return r;
    };
...
},{"./View.js":"5cUXS","url:../../img/icons.svg":"loVOp","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"eAsNV":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _viewJs = require("./View.js");
var _viewJsDefault = parcelHelpers.interopDefault(_viewJs);
var _iconsSvg = require("url:../../img/icons.svg");
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
class addRecepieView extends (0, _viewJsDefault.default) {
...
exports.default = new addRecepieView();
...
class BookmarksView extends (0, _viewJsDefault.default) {
    ...
    _errorMessage = "No bookmarks yet, find one and bookmark it!";
    _message = "";
    addHandlerRender(handler) {
...
},{"./View.js":"5cUXS","./previewView.js":"1FDQ6","url:../../img/icons.svg":"loVOp","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"dXNgZ":[function(require,module,exports) {
/**
